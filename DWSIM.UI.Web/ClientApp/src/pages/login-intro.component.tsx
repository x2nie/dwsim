...
const LoginIntroPage: React.FC<IHomePageProps> = () => {
  const onRegisterClick = async () => {
    try {
      ...
      systemService.openUrlInLocalBrowser(
        "https://simulate365.com/registration-dwsim-pro/"
      );
    } catch (error) {
      console.log(
        "An error occurred while navigating to register page.",
        error
      );
    }
  };
  ...
  const OpenAnchorInSystemBrowser = (
    ...
    alert(
      "OpenAnchorInSystemBrowser() supports only 'a' element. 'a' element not found in invocation path."
    );
  ...
  return (
    ...
    >
      ...
      >
        <a href="https://simulate365.com" onClick={OpenAnchorInSystemBrowser}>
          <img src="/s365-full-logo.png" style={{ width: "250px" }} />
        </a>
      </div>
      <p>
        Access <b>Simulate 365 DASHBOARD</b>, the "all in one place" simulation
        platform and use it free for:
        <ul>
